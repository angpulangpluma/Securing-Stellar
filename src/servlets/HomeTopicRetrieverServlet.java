...
/**
 * Servlet implementation class HomeTopicRetrieverServlet
 */
@WebServlet("/gettopicupdateshome")
public class HomeTopicRetrieverServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HomeTopicRetrieverServlet() {
        super();
